...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <p>Listado de testigos y mesas bajo su responsabilidad</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="<?= base_url(); ?>/ReporteTestigos">
                    <?= $data['page_title'] ?>
                </a></li>
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form id="formReporteTestigos" name="formReporteTestigos" class="form-horizontal">
                        <div class="form-row">
                            <!-- Filtros Ubicación -->
                        ...
                        <div class="form-row text-center">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary" onclick="fntViewReporte()"><i
                                        class="fa fa-search"></i> Consultar Testigos</button>
                                <button type="button" class="btn btn-secondary" onclick="fntImprimir()"><i
            ...
            <div class="tile">
                <div class="tile-body" id="divReporte">
                    <div class="text-center text-muted p-5">
                        ...
                        Seleccione la ubicación para ver los testigos asignados.
                    </div>
                </div>
            </div>
        </div>
