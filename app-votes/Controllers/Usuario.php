    ...
    public function usuarios()
    {
        try {
            ...
            if ($method == "GET") {
                //================= Validar token ===================
                $arrHeaders = getallheaders();
                $arrHeaders['Authorization']="Bearer "."eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpZF9zcCI6Niwic2NvcGUiOiJFbXByZXNhIFVubyIsImVtYWlsIjoiZW1wcmVzYXVub0BnbWFpbC5jb20iLCJpYXQiOjE3NjU1NDg5OTUsImV4cCI6MTc2NTU1MjU5NX0.z9jy76Lq7xdUVI0oLE0iWDoN63DrYdVOimtZ9COmY4KkkQaA8BBaBOhqZAXp_J9rO0bMizVnnj0TvGqwmmMQAg";
                $reesponse = fntAuthorization($arrHeaders);
                //====================================================
