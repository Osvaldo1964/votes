<?php
    ...
    class rolesModel extends Mysql
    {
        ...
        public function getPlace(int $idcliente)
        {
            $this->intIdCliente = $idcliente;
            $sql = "SELECT d.name_department,m.name_municipality,z.name_zone,p.nameplace_place,p.ape1_place,p.ape2_place,p.nom1_place,p.nom2_place,p.mesa_place
                    FROM places p
